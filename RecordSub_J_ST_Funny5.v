...
Inductive step : tm -> tm -> Prop :=
  ...
  | ST_Funny5 : forall t1,
        tm_app tm_rnil t1 ==> tm_app t1 tm_rnil
...
証明:
  ...
  i = i1 かつ i = i2 のときは i1 = i2 となり i1 <> i2 と矛盾し、否定的に成立する。
 *)
(** [] *)
...
Proof with eauto.
  ...
  Case "T_App".
    ...
    SCase "ST_Funny5".
      destruct (canonical_forms_of_arrow_types _ _ _ _ HT1) as [ x [ S1 [ s2 N ] ] ].
      constructor.
      now inversion N.
  Case "T_Proj".
